...
<head>
    ...
    {{-- css aji --}}
    <link rel="stylesheet" href="/assets/css/aji.css">
</head>
...
<body class="">
    ...
    -->
            <div class="sidebar-wrapper">
                ...
                <ul class="nav">
                    <li class="{{ ($title === "Pendaftaran Anggota") ? 'active' : '' }}">
                        <a href="/pendaftaran-anggota">
                            <i class="tim-icons icon-badge"></i>
                            <p>Pendaftaran Anggota</p>
                        </a>
                    </li>
                    <li class="{{ ($title === "Info Rekening") ? 'active' : '' }}">
                        <a href="/info-rekening">
                            <i class="tim-icons icon-credit-card"></i>
                            <p>info Rekening</p>
                        </a>
                    </li>
                    <li class="{{ ($title === "Berat Badan Ideal") ? 'active' : '' }}">
                        <a href="/berat-badan-ideal">
                            <i class="tim-icons icon-user-run"></i>
                            <p>Berat Badan Ideal</p>
                        </a>
                    </li>
                    <li class="{{ ($title === "Nilai Ujian") ? 'active' : '' }}">
                        <a href="/nilai-siswa">
                            <i class="tim-icons icon-paper"></i>
                            <p>Nilai Ujian</p>
                        </a>
                    </li>
                    <li class="{{ ($title === "Edit Data Pendaftaran") ? 'active' : '' }}">
                        <a href="/detail-data-siswa">
                            <i class="tim-icons icon-single-02"></i>
                            <p>Data Pendaftaran</p>
                        </a>
                    </li>
                    <li class="{{ ($title === "Change Password") ? 'active' : '' }}">
                        <a href="/password-client">
