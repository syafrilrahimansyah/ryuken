                ...
                <div class="card-header">
                    <div class="row">
                        <div class="col-sm-6 text-left">
                            ...
                            <h2 class="card-title">Edit Data Nilai Siswa</h2>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                    <div class="chart-area">
                        <div class="card-body">
                            <div class="">
                                <div>
                                    <form action="/edit-data-nilai/{{ $nilaisiswa->id }}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        ...
                                        <div class="container mt-4 mb-4">
                                            <div class="row">
                                                ...
                                                <div class="col-md-0 offset-1">
                                                    <a href="/data-nilai-siswa" class="btn btn-secondary">Kembali</a>
                                                </div>
                                            </div>
                                        </div>
                                    </form>
