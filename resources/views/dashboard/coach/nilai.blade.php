                ...
                <div class="card-header">
                    <div class="row">
                        <div class="col-sm-6 text-left">
                            ...
                            <h2 class="card-title">Nilai Ujian Siswa</h2>
                        </div>
                        <div class="col-sm-5 offset-1 mt-4">
                            <form class="form-inline" action="/nilai-ujian-siswa" method="GET">
                        ...
                        <div class="container">
                            <a href="/tambah-nilai-ujian" class="btn btn-outline-primary">Tambah Data</a>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                                    ...
                                    <tbody>
                                        ...
                                        @foreach($nilaisiswas as $nilaisiswa)
                                            <tr>
                                                <td><?= $i; ?></td>
                                                <td>
                                                    <a class="badge badge-success" href="/edit-nilai-ujian/{{ $nilaisiswa->id }}">edit</a>
                                                    <a class="badge badge-warning" href="/hapus-nilai-ujian/{{ $nilaisiswa->id }}" onclick="">hapus</a>
                                                </td>
